...
class TelaInternos:
    def __init__(self, master, usuario):
        ...
        ttk.Label(self.frm, text="Selecione o módulo:").grid(column=0, row=1, pady=5)

       
        self.btn_funcionarios = ttk.Button(self.frm, text="Gerenciar Funcionários")
        self.btn_funcionarios.grid(column=0, row=2, pady=10, sticky=EW)

       
        self.btn_pacientes = ttk.Button(self.frm, text="Gerenciar Pacientes")
