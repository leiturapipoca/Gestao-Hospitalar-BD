...
class GerenciarProfsController:
    ...
    def handle_adicionar_prof(self):
        if not isinstance(self.view, TelaAdicionarProf):
            logging.warning("ação adicionar profissional foi selecionada fora da tela de adicionar profissional")
            self.voltar_to_menu()
        else:
    ...
    def handle_remover_prof(self):
        ...
        if not isinstance(self.view, TelaRemoverProf):
            logging.warning("ação remover profissional foi selecionada fora da tela de remover profissional")
            self.voltar_to_menu()
        else:
            try:
    ...
    def handle_consultar_prof(self):
        ...
        if not isinstance(self.view, TelaConsultarProf):
            logging.warning("ação remover profissional foi selecionada fora da tela de remover profissional")
            self.voltar_to_menu()
        else:
            try:
